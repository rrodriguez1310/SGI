...
input {margin-top: 0px;}
			...
			<div class="col-md-12">
				<div class="row clearfix">
					...
					<div class="col-md-4 column">
						<div class="panel panel-default">
							<!-- Default panel contents -->
							<div class="panel-heading"><Strong>Información Rendición Viático</Strong></div>
							<!-- List group -->
								...
								<li class="list-group-item">Archivo:
                                    <?php
                                    // echo acortarurl($data['datosViatico']['url_documento']);
	...
	<div style="margin-left:15px">
		<div class="row">
			<a href="<?php echo $this->Html->url(array("action"=>"lista_todos"));?>"  class="btn btn-info btn-mx">
