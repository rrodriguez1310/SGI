	...
	<div>
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-md-6">
					<?php echo $this->Form->input('numero_documento', array("class"=>"col-xs-4 form-control", "label"=>false, 'placeholder'=>'N° Boleta', 'required'=>true));?>
				</div>
			</div>
		...
		<div class="form-group">
			<div class="col-md-6 col-md-offset-4">
				<div class="alert alert-info">
					<h4> Neto s/d: $ <span class="neto_sd"> </span></h4>
					<?php echo $this->Form->hidden('neto_descuento');?>
					<h4> Descuentos: $ <span class="totalDescuentos"> </span></h4>
					<h4> Neto c/d: $ <span class="netoCd"> </span></h4>
					<h4> <span class="textoIva">Iva : </span><span class="iva"> </span></h4>
					...
					<table style="text-align: left; width: 700px; height: 172px;" border="0"cellpadding="2" cellspacing="2">
						<tbody>
							...
							<tr>
								...
								<td style="vertical-align: bottom; width: 458px;"><?php echo $this->Form->input('dimUno', array("class"=>"dimencionUno", "label"=>false, 'options'=>$dimensionUno, 'placeholder'=>'Gerencias'));?></td>
							</tr>
							...
							<tr>
								...
								<td style="vertical-align: bottom; width: 458px;"><?php echo $this->Form->input('codigoPresupuestario', array("type"=>"select", "options" =>array(""=>""), "class"=>"codigoPresupuestario requerido", "label"=>false, 'placeholder'=>'Codigo Presupuestario', 'required'=>true));?></td>
							</tr>
