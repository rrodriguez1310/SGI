			...
			<tr class="<?php echo $class;?>">
				...
				<td width="15%">
					...
					<?php if($ordenCompras["ComprasProductosTotale"]["estado"] == 6 || $ordenCompras["ComprasProductosTotale"]["estado"] == 4) : ?>
						<a class="btn-sm btn btn-warning tool btn-xs" title="" data-placement="top" data-toggle="tooltip" href="<?php echo $this->Html->url(array("action"=>"plantilla_boletas_facturas_add", $ordenCompras["ComprasProductosTotale"]["id"])); ?>" data-original-title="Usar plantilla"><i class="fa fa-recycle"></i></a/>	
					<?php endif; ?>
