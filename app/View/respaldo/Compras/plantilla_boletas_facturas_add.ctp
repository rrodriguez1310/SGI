<form class="form-horizontal" method="post" id="fileinfo" name="fileinfo" role="form">
	...
	<fieldset>
		...
		<div class="form-group">
			...
			<div class="col-md-6">
				<?php echo $this->Form->input('titulo', array("class"=>"col-xs-4 form-control", "label"=>false, 'placeholder'=>'titulo', 'default'=>$comprasProductosTotale["ComprasProductosTotale"]["titulo"], 'required'=>true));?>
			</div>
		</div>
	...
	<div class="form-group">
		<div class="col-md-6 col-md-offset-4">
			<div class="alert alert-info">
				...
				<h4> <span class="textoIva">Iva : $</span> <span class="iva"><?php echo number_format($comprasProductosTotale["ComprasProductosTotale"]["total"] - $comprasProductosTotale["ComprasProductosTotale"]["neto_descuento"], 0, '', '.'); ?> </span></h4>
...
<div class="modal fade" id="ingresoProducto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog" style="width:800px;">
  	<form id="formProducto" role="form"  method="Post" action="/desarrolloV2/servicios/compraUnitario">
