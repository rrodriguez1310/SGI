<div ng-controller="controllerGerenciaCompras" ng-init="codigoEstado(<?php echo $codigo['ComprasTarjetasEstado']['id']?>)">
...
<?php 
	echo $this->Html->script(array(
		...
		'angularjs/servicios/compra_tarjeta/gerenciaCompraTarjeta',
		'angularjs/directivas/modal/modal',
		'angularjs/controladores/compra_tarjeta/gerencia_compra_tarjeta',
