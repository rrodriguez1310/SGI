<div ng-controller="controllerSolicitanteCompras">
...
<?php 
	echo $this->Html->script(array(
		...
		'angularjs/servicios/compra_tarjeta/solicitanteCompraTarjeta',
		'angularjs/directivas/modal/modal',
		'angularjs/controladores/compra_tarjeta/controllerSolicitanteCompras',
