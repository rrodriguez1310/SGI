<div ng-controller="catalogacionRequerimientosAdd" ng-cloak>
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<form class="form-horizontal" novalidate name="catalogacionRequerimientosForm">
						...
						<div class="panel-body">
							...
							<div class="form-group" ng-class="{ 'has-error': !catalogacionRequerimientosForm.detalleValor.$valid }">
								<div ng-switch on="detalle.tipo">
									...
									<label class="col-md-3 control-label ">Valor</label>
										<div class="col-md-9">
											<input type="text" class="form-control sube" name="detalleValor" name="detalleValor" ng-model="detalle.valor" ng-required="formulario.CatalogacionRTag.length == 0" placeholder="Ingresa valor">
										</div>	
									</div>
								</div>							
							</div>
							...
							<div class="form-gruop" ng-if="formulario.CatalogacionRTag.length != 0">
								<table class="table table-condensed">
									...
									<tbody>
										<tr ng-repeat="(key, valores) in formulario.CatalogacionRTag">
							...
							<div ng-switch on="tipoEntrega">
								<div ng-switch-when="0">
									...
									<div class="form-group" ng-class="{ 'has-error': !catalogacionRequerimientosForm.nombreCarpeta.$valid }">
										<label class="control-label col-md-3" for="nombreCarpeta">
											Nombre de carpeta
										</label>
										<div class="col-md-9">
											<input type="text" class="form-control sube" name="nombreCarpeta" id="nombreCarpeta" ng-model="formulario.CatalogacionRDigitale.ruta" ng-required="tipoEntrega==0">	
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-12">
								...
								<div ng-switch-when="1">
									...
									<div ng-if="formulario.CatalogacionRFisico.logo=='SI'">
										<div class="form-group" ng-class="{ 'has-error': !catalogacionRequerimientosForm.posicionLogo.$valid }">
											...
											<div class="col-md-9">
												<select2 class="form-control" ng-model="formulario.CatalogacionRFisico.logo_posicion" id="posicionLogo" name="posicionLogo" placeholder="Seleccione una posición para el logo" s2-options="logoPosicion for logoPosicion in logoPosicionList" ng-required="formulario.CatalogacionRFisico.logo=='SI'">
													<option value=""></option>
												</select2>
											</div>	
										</div>
									...
									<div class="form-group">
										<div class="col-md-12">
											...
											<textarea class="form-control" name="observacionEntrega" id="observacionEntrega" ng-model="formulario.CatalogacionRFisico.observacion" rows="5">
					...
					<div class="form-group">
						<div class="col-md-12 text-center">
							<button class="btn btn-primary btn-lg" ng-disabled="(!catalogacionRequerimientosForm.$valid || (formulario.CatalogacionRTag.length == 0)) || registrando" ng-click="registrarRequerimiento()"><i class="fa fa-pencil"></i> Registrar</button>
