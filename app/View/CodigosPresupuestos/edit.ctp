<div ng-controller="codigosPresupuestosEdit" ng-cloak ng-init="idCodigoPresupuesto(<?php echo $this->request->params['pass'][0] ?>)">
	<p ng-bind-html="cargador" ng-show="loader"></p>
	<div ng-show="detalle">
		<div class="row">
			<div class="col-md-12 text-center">
				<h4>Editar Codigo Presupuestario</h4>
			</div>
		</div>
		<br/>
		<div class="row">
			<div class="col-md-12">
				<form class="form-horizontal" name="codigosPresupuestoEdit" novalidate>
					...
					<div class="form-group">
						<div class="col-md-12 text-center">
							<button class="btn btn-primary btn-lg" ng-disabled="!codigosPresupuestoEdit.$valid" ng-click="actualizarCodigoPresupuesto()"><i class="fa fa-pencil-square-o"></i> Actualizar</button>
