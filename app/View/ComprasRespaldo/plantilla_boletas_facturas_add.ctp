<form class="form-horizontal" method="post" id="fileinfo" name="fileinfo" role="form">
	<?php
	 /*
		...
		$attributes = array('div' => 'input', 'type' => 'radio', 'options' => $options, 'class'=>'radio_botom', "default"=>$comprasProductosTotale['TiposDocumento']['id']);
	...
	<fieldset>
		...
		<!--div class="form-group">
			...
			<div class="col-md-6">
				<?php echo $this->Form->input('numero_documento', array("class"=>"col-xs-4 form-control", "label"=>false, 'placeholder'=>'N° Documento'));?>
			</div>
		</div-->
		...
		<div class="form-group">
			...
			<div class="col-md-6">
				<?php echo $this->Form->input('titulo', array("class"=>"col-xs-4 form-control requerido", "label"=>false, 'placeholder'=>'titulo', 'default'=>$comprasProductosTotale["ComprasProductosTotale"]["titulo"]));?>
			</div>
		</div>
	...
	<div class="form-group">
		...
		<div class="col-md-6">
			<label class="radio-inline baja"><input type="radio" name="tipoImpuesto" id="tipoImpuesto1" value="1" class="requerido">Afecto </label>
			<label class="radio-inline baja"><input type="radio" name="tipoImpuesto" id="tipoImpuesto2" value="2" class="requerido">Exento  </label>
			<label class="radio-inline baja"><input type="radio" name="tipoImpuesto" id="tipoImpuesto3" value="3" class="requerido">Honorarios  </label>
		</div>
	</div>
	...
	<div class="form-group">
		<div class="col-md-6 col-md-offset-4">
			<button type="submit" class="btn-block btn btn-primary btn-lg generarOrden"><i class="fa fa-file-text-o"></i> Generar Requerimiento</button>
		</div>
	</div>
</form>
<!-- Modal -->
	...
	$(document).ready(function(){
		...
		$(document).on('click','.editar',function(){
			...
			placeholder: "Seleccione Proveedor",
				allowClear: true,
				width:'100%',
			}).select2('val',dimCuatro);
			$("#dimCinco").select2({
			placeholder: "Seleccione Proveedor",
				allowClear: true,
				width:'100%',
			}).select2('val',dimCinco);
			$("#proyecto").select2({
			placeholder: "Seleccione Proveedor",
				allowClear: true,
				width:'100%',
			}).select2('val',proyecto);
