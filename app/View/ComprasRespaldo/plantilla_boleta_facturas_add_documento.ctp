x<form class="form-horizontal" method="post" id="fileinfo" name="fileinfo" role="form">
	<?php
				...
				$.post(destino, datos, function (data) {
					...
					if(obj.cantidad != "")
					{
						...
						if(obj.proyecto != "")
						{
							...
							tdHtml += "<td title='"+dimProyecto[0]+"' id='proyecto-"+dimProyecto[0]+"' > <input type='hidden' name='proyecto[]' value='"+obj.proyecto+"'>"+dimProyecto[1]+"</td>";
						}
						else
						{
