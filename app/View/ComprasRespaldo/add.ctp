	...
	<fieldset><legend>Detalle de productos ingresados</legend>
		...
		<fieldset><legend>Totales y descuentos</legend>
			...
			<div class="form-group">
				...
				<div class="col-md-6">
					<label class="radio-inline baja"><input type="radio" name="tipoImpuesto" id="tipoImpuesto1" value="1" required>Afecto (19%)</label>
					<label class="radio-inline baja"><input type="radio" name="tipoImpuesto" id="tipoImpuesto2" value="2" required>Exento (0%)</label>
					<label class="radio-inline baja"><input type="radio" name="tipoImpuesto" id="tipoImpuesto3" value="3" required>Retención (10%)</label>
				</div>
			</div>
