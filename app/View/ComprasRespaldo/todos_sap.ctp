		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<ul class="list-inline menu_superior_angular">
					<li ng-show="ver"><a href="<?php echo $this->Html->url(array("action"=>"view"));?>/{{id}}" class="btn-sm btn btn-primary tool" data-placement="bottom" data-toggle="tooltip" data-original-title="Ver"><i class="fa fa-eye"></i></a></li>
					...
					<li ng-show="asociarFac"><a href="<?php echo $this->Html->url(array("action"=>"asociar_facturas"));?>/{{id}}" class="btn-sm btn btn-info tool" data-placement="bottom" data-toggle="tooltip" data-original-title="Asociar Doc. Tributario"><i class="fa fa-file-text"></i></a></li>
