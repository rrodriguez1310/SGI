<div ng-controller="controllerAreaCompras" ng-init="codigoEstado(<?php echo $codigo['ComprasTarjetasEstado']['id']?>)">
...
<?php 
	echo $this->Html->script(array(
		...
		'angularjs/servicios/compra_tarjeta/areaCompraTarjeta',
		'angularjs/directivas/modal/modal',
		'angularjs/controladores/compra_tarjeta/area_compra_tarjeta',
