<div ng-controller="sistemasBitacorasAdd" ng-cloak ng-init="usuarioId(<?php echo $this->Session->Read("PerfilUsuario.idUsuario"); ?>)">
	...
	<div ng-show="ShowContenido">
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<form class="form-horizontal" name="sistemasBitacorasAddForm" novalidate>
					<div class="form-group" ng-class="{ 'has-error': (sistemasBitacorasAddForm.inicioFecha.$invalid || sistemasBitacorasAddForm.inicioHora.$invalid) ? true : false }">
					...
					<div class="form-group" ng-class="{ 'has-error': (sistemasBitacorasAddForm.terminoFecha.$invalid || sistemasBitacorasAddForm.terminoHora.$invalid) ? true : false }">
					...
					<div class="form-group" ng-class="{ 'has-error': sistemasBitacorasAddForm.responsable.$invalid }">
					...
					<div class="form-group" ng-class="{ 'has-error': sistemasBitacorasAddForm.gerencia.$invalid }">
					...
					<div class="form-group" ng-class="{ 'has-error': sistemasBitacorasAddForm.areas.$invalid }">
						<label class="control-label col-md-3" for="areas">Área</label>
						<div class="col-md-9">
							<select type="text" class="form-control select2" name="areas" id="areas" ng-change="buscaTrabajadoresArea()" ng-options="area.id as (area.nombre | uppercase) for area in areasList | orderBy: 'nombre' | filter:{gerencia_id : gerencia}:true" ng-model="formulario.SistemasBitacora.area_id" placeholder="Seleccione un trabajador" required>
								<option value=""></option>
							</select>	
						</div>
					</div>
					...
					<div class="form-group" ng-class="{ 'has-error': sistemasBitacorasAddForm.titulo.$invalid }">
					...
					<div class="form-group" ng-class="{ 'has-error': sistemasBitacorasAddForm.observacionIngreso.$invalid }">
					...
					<div class="form-group">
						<div class="col-md-12 text-center">
							<button class="btn btn-primary btn-lg" ng-disabled="sistemasBitacorasAddForm.$invalid || registrando" ng-click="registrarBitacora()"><i class="fa fa-pencil"></i> Registrar</button>
