...
<div class="center col-md-8 col-md-offset-2">
            <div class="row">
            <div class="col-sm-4">	
            <a href="<?= $this->Html->url(array("controller"=>"solicitudes_requerimientos", "action"=>"index"))?>" class="btn btn-info btn-mx" id="area"><i class="fa fa-mail-reply-all fa-mx "></i> Volver</a>
            </div>
            </div>
        </div>
