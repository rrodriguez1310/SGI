...
<form class="form-horizontal"  ng-submit="guardaRendicionSubmit(<?=$idsolicitud?>)" method="post" name="formularioSolicitud" id="formularioSolicitud">
<div>
	<fieldset>
	...
	<div class="form-group">
		<div class="col-md-6 col-md-offset-4">
			<div class="alert alert-info">
				...
				<h4> Total: $ {{totalGastos | number:0}}<!--div ng-bind="totalGastos"></div><span class="total"><div ng-bind="totalGastos"></div></span--></h4> 
...
<?php 
	...
	echo $this->Html->script(array(
		...
		'angularjs/controladores/solicitudes_rendicion/solicitudes_rendicion_rechazo',
