            ...
            <form class="form-horizontal" name="transporteEditForm" novalidate>
              <div class="col-xs-10 offset-2">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                      <select  class="form-control mayuscula" ng-change="cambiaMedio()" ng-model="formulario.tipo" ng-options="item as item.nombre for item in tipoEvento ">
                      <option value=''>- SELECCIONE UN EVENTO -</option>
                      </select> 
                    </div>
                  </div>
				  <div ng-show="muestraDataPartidos">
                <div class="form-group">
                    <label class="col-md-2 control-label">Programa :</label>
                    <div class="col-md-4">
                      <select  class="form-control mayuscula" ng-change="cambiaMedio()" ng-model="formulario.programas[posicion2].evento" ng-options="item as item.equipos for item in dataEvento ">
                  ...
                  <div class="col-md-8">
                    <input type="text" class="form-control mayuscula" name="lugar" ng-model="formulario.programas[posicion2].tipo_produccion" placeholder="Ingresa tipo de produccion">
                  </div>
                </div>
              <div  class="form-group">
                  <label class="col-md-2 control-label">Campeonato :</label>
                  <div class="col-md-8">
                    <input type="text" class="form-control mayuscula" name="lugar" ng-model="formulario.programas[posicion2].campeonato" placeholder="Ingresa campenoato">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-2 control-label">Hora Inicio :</label>
                  <div class="col-md-3">
                    <input type="text" id="hora_ini_evento" class="form-control mayuscula" name="hora_ini_evento" ng-model="formulario.programas[posicion2].hora_ini_evento"  placeholder="Ingresa Hora Inicio">
                  </div>
                  <label class="col-md-2 control-label">Hora Termino :</label>
                  <div class="col-md-3">
                    <input type="text" id="hora_out_evento" class="form-control mayuscula" name="hora_out_evento" ng-model="formulario.programas[posicion2].hora_out_evento" placeholder="Ingresa Hora Termino">
                  </div>
                </div>
                <div  class="form-group">
                  <label class="col-md-2 control-label">Fecha :</label>
                  <div class="col-md-8">
                    <input type="text" class="form-control mayuscula" name="fecha_partido" ng-model="formulario.programas[posicion2].fecha_partido" placeholder="Ingresa fecha">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-2 control-label">Lugar :</label>
                  <div class="col-md-8">
                    <input type="text" class="form-control mayuscula" name="lugar" ng-model="formulario.programas[posicion2].lugar" placeholder="Ingresa Lugar">
                  </div>
                </div>
                 <div  class="form-group">
                  <label class="col-md-2 control-label">Fecha Campeonato :</label>
                  <div class="col-md-8">
                    <input type="text" class="form-control mayuscula" name="fecha" ng-model="formulario.programas[posicion2].fecha" placeholder="Ingresa fecha">
                  </div>
                </div>
                <div  class="form-group">
                    <label class="col-md-2 control-label">Señales :</label>
                    <div class="col-md-4">
                      <select multiple class="form-control mayuscula" ng-model="formulario.programas[posicion2].senales" ng-options="item as item.Channel.nombre for item in senales track by item.Channel.id"></select>
                    </div>
                  </div>
                  <div ng-show="showProductores==''" class="form-group">
                    <label class="col-md-2 control-label">Productor :</label>
                    <div class="col-md-4">
                      <select multiple class="form-control mayuscula" ng-model="formulario.programas[posicion2].productoresArray" ng-options="item as item.nombre for item in dataProductores track by item.id"></select>
                    </div>
                  </div>
                  <div  ng-show="showProductores" class="form-group">
                    <label class="col-md-2 control-label">Productor :</label>
                    <div class="col-md-8">
                    <input type="text" class="form-control mayuscula" name="productores" ng-model="formulario.programas[posicion2].productores" placeholder="Ingresa Productores">
                  </div>
                  </div>
                  
				  </div>
          <div ng-show="muestraDataNoticias">
          <div class="form-group">
                    <label class="col-md-2 control-label">Programa :</label>
                    <div class="col-md-4">
                      <select  class="form-control mayuscula" ng-change="cambiaMedio()" ng-model="formulario.programas[posicion2].evento" ng-options="item as item.nombre for item in dataProgra ">
                      <option value=''>- SELECCIONE UN PROGRAMA -</option>
                      </select> 
                    </div>
                  </div>                 
                ...
                <div  class="form-group">
                     <label class="col-md-2 control-label">Fecha :</label>
                  <div class="col-md-8">
                   <input class="form-control mayuscula" id="date" name="date"ng-model="formulario.programas[posicion2].fecha_partido"  placeholder="seleccione fecha"  type="text" required/>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-md-2 control-label">Lugar :</label>
                  <div class="col-md-8">
                    <select  type="text" class="form-control mayuscula" name="lugar" ng-model="formulario.programas[posicion2].lugar" ng-options="item.nombre as item.nombre for item in lugares" >
                ...
                <div  class="form-group">
                    <label class="col-md-2 control-label">Señales :</label>
                    <div class="col-md-4">
                      <select multiple class="form-control mayuscula" ng-model="formulario.programas[posicion2].senalesPrograma" ng-options="item as item.nombre for item in dataSenales track by item.id"></select>
...
<a  id="btn_new" data-toggle="collapse" data-parent="#accordion" href="#collapse2">Satélite  <span class="fa fa-angle-right"></span></a>
              ...
              <div id="collapse2" class="panel-collapse collapse">
                <div class="panel-body">
                  ...
                  <div class="col-md-4">
                     <select multiple class="form-control mayuscula" name="satelite"  ng-model="formulario.satelite2[posicion].prestador" ng-options="item as item.nombre for item in transmisionSenalesArray | filter:{medio:'3'}"></select>
                  </div>                             
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label class="col-md-2 control-label">Hora Inicio :</label>
                    <div class="col-md-4">
                      <input type="text" id="hora_ini_satelite" class="form-control mayuscula" name="hora_ini_satelite" ng-model="formulario.satelite2[posicion].hora_ini_satelite" placeholder="Ingresa Hora Inicio">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-md-2 control-label">Hora Termino :</label>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                      <input type="text" class="form-control mayuscula" name="signal_level" ng-model="formulario.satelite2[posicion].signal_level" placeholder="Ingresa signal_level">
                    </div>
                  </div>
                  <div class="form-group">
              ...
              <div id="collapse1" class="panel-collapse collapse">
                <div class="panel-body">
                  ...
                  <div class="form-group">
                    <label class="col-md-2 control-label">Hora Inicio :</label>
                    <div class="col-md-3">
                      <input type="text" id="hora_ini_fibra" class="form-control mayuscula" name="hora_ini_fibra" ng-model="formulario.fibra_optica[posicion].hora_ini_fibra" placeholder="Ingresa Hora Inicio">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-md-2 control-label">Hora Termino :</label>
                    <div class="col-md-3">
                      <input type="text" id="hora_ini_fibra" class="form-control mayuscula" name="hora_out_fibra" ng-model="formulario.fibra_optica[posicion].hora_out_fibra" placeholder="Ingresa Hora Termino">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-md-2 control-label">RX de Señal :</label>
                  ...
                  <label class="col-md-2 control-label">Prestador Servicio :</label>
                  <div class="col-md-4">
                     <select multiple class="form-control mayuscula" name="satelite"  ng-model="formulario.fibra_optica[posicion].prestador" ng-options="item as item.nombre for item in transmisionSenalesArray | filter:{medio:'1'}"></select>
                  </div>
                  <div class="form-group">
                    <label class="col-md-2 control-label">Observación:</label>
                    <div class="col-md-4">
              ...
              <div id="collapse3" class="panel-collapse collapse">
                <div class="panel-body">
                  ...
                  <div class="form-group">
                    <label class="col-md-2 control-label">Hora Inicio :</label>
                    <div class="col-md-3">
                      <input type="text" id="hora_ini_micro" class="form-control mayuscula" name="hora_ini_micro" ng-model="formulario.micro_ondas[posicion].hora_ini_micro" placeholder="Ingresa Hora Inicio">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-md-2 control-label">Hora Termino :</label>
                    <div class="col-md-3">
                      <input type="text" id="hora_ini_micro" class="form-control mayuscula" name="hora_out_micro" ng-model="formulario.micro_ondas[posicion].hora_out_micro" placeholder="Ingresa Hora Termino">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-md-2 control-label">RX de Señal :</label>
                  ...
                  <label class="col-md-2 control-label">Prestador Servicio :</label>
                  <div class="col-md-4">
                     <select multiple class="form-control mayuscula" name="satelite"  ng-model="formulario.micro_ondas[posicion].prestador" ng-options="item as item.nombre for item in transmisionSenalesArray | filter:{medio:'2'}"></select>
                  </div>
                  <div class="form-group">
                    <label class="col-md-2 control-label">Observación:</label>
                    <div class="col-md-4">
...
<a id="btn_new4" data-toggle="collapse" data-parent="#accordion" href="#collapse4">Otro <span class="fa fa-angle-right"></a>
            ...
            <div class="form-group">
             <label ng-repeat="medios in posicionesMochila" style="font-size: 15px;">
                  ...
                  <!-- <label class="col-md-2 control-label">Prestador Servicio :</label>
                  <div class="col-md-4">
                     <select multiple class="form-control mayuscula" name="satelite"  ng-model="formulario.otros[posicion][posicionMochi].prestador" ng-options="item as item.nombre for item in prestadoresArray | filter:{medio:'2'}"></select>
                  </div>-->
