...
<?php echo $this->Form->create('InduccionQuiz'); ?>
	<fieldset>
		<legend><?php echo __('Edit Induccion Quiz'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('InduccionQuiz.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('InduccionQuiz.id'))); ?></li>
