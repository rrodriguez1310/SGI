...
<?php echo $this->Form->create('CompaniesComentario'); ?>
	<fieldset>
		<legend><?php echo __('Edit Companies Comentario'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CompaniesComentario.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('CompaniesComentario.id'))); ?></li>
