<table >
	<tr>
		<td colspan="2" style="background:#cccccc;padding:5px"><h3>Información Solicitud Requerimiento Compra</h3></td>
	</tr>
    ...
    <tr>
		<td width="100" style="padding:5px"><strong>Proyecto:</strong></td>
