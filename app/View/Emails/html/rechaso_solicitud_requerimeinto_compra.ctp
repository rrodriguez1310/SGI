<table >
	<tr>
		<td colspan="2" style="background:#cccccc;padding:5px"><h3>Información Rechazo Solicitud Requerimiento Compra</h3></td>
	</tr>
    ...
    <tr>
		<td width="100" style="padding:5px"><strong>Motivo Rechazo:</strong></td>
	...
	<tr>
		<td width="100" style="padding:5px"><a href="http://192.168.1.25/qa/solicitudes_requerimientos<?=$destino?>" target="_blank">Ir a sgi-v3</a></td>
	</tr>
</table>