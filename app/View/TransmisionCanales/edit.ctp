<div class="col-md-10 col-md-offset-1">
	<?php echo $this->Form->create('TransmisionCanale', array('class' => 'form-horizontal')); ?>
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<?php echo $this->Form->input('nombre', array('type'=>'text',"class"=>"form-control requerido", "placeholder"=>"Nombre Canal", "label"=>false, "required"=>"required", 'maxlength'=>'100', "id"=>"Nombre"));?>
				</div>
			</div>
