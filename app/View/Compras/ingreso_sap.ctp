...
<?php 
	...
	if($emailAprobadorSapRequerimientos[0].'.cl' == "jmariangel@cdf.cl" || $emailAprobadorSapRequerimientos[0].'.cl' == "dortiz@cdf.cl" || $emailAprobadorSapRequerimientos[0].'.cl' == "cquijada@cdf.cl") 	
	{
...
?>
	...
	<?php 
		foreach($ordenCompra as $key=>$ordenCompras) : 
			if(($ordenCompras["ComprasProductosTotale"]["tipos_documento_id"] != "" && $emailAprobadorSapRequerimientos[0].'.cl' != "cperez@cdf.cl") || $emailAprobadorSapRequerimientos[0].'.cl' == "cperez@cdf.cl" || $emailAprobadorSapRequerimientos[0].'.cl' == "ddiaz@cdf.cl") : 
				$class="";
				$tooltip = "";
