<form class="form-horizontal" method="post" id="fileinfo" name="fileinfo" role="form">
	...
	<div class="form-group">
		...
		<div class="col-md-6">
			<?php echo $this->Form->input('adjunto.', array("type"=>"file", 'multiple', "class"=>"", "label"=>false, 'placeholder'=>'Adjuntar archivo', 'required'=>true));?>
...
<div class="modal fade" id="ingresoProducto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog" style="width:800px;">
  	<form id="formProducto" role="form"  method="Post" action="<?php echo $this->Html->link(array("controller"=>"servicios", "action"=>"compraUnitario")); ?>">
