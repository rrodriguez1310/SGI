	...
	<div>
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-md-6">
					<?php echo $this->Form->input('numero_documento', array("class"=>"col-xs-4 form-control requerido", "label"=>false, 'placeholder'=>'N° Boleta'));?>
				</div>
			</div>
	...
	$("#tipo_documento17, #tipo_documento18, #tipo_documento19, #tipo_documento20 , #tipo_documento21, #tipo_documento22").click(function(){
		...
		{ 
			...
			if(valorEnPesosConDescuento != 0)
			{
				...
				{
					console.log(eval(valorEnPesosConDescuento)+eval(valorExento));
