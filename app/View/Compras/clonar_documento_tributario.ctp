<form class="form-horizontal" method="post" id="fileinfo" name="fileinfo" role="form">
	...
	<fieldset>
		...
		<div class="form-group">
			...
			<div class="col-md-6">
				<?php echo $this->Form->input('numero_documento', array("class"=>"col-xs-4 form-control", "label"=>false, 'placeholder'=>'N° Boleta', 'default'=>$comprasProductosTotale["ComprasFactura"][0]["numero_documento"], 'required'=>true));?>
			</div>
		</div>
	...
	<div class="form-group">
		<div class="col-md-6 col-md-offset-4">
			<div class="alert alert-info">
				<h4> Neto Afecto s/d: $ <span class="neto_sd"><?php echo array_sum($netoSinDescuento); ?></span></h4>
				...
				<h4> Neto Total c/d: $ <span class="netoCd"><?php echo $comprasProductosTotale["ComprasProductosTotale"]["neto_descuento"]; ?> </span></h4>
