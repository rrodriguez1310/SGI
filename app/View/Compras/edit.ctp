	...
	<fieldset>
		...
		<div class="form-group">
			...
			<div class="col-md-6">
				...
				<?php echo $this->Form->hidden('total', array('value'=>$comprasProductosTotale['ComprasProductosTotale']['total']));?>
				<?php echo $this->Form->hidden('id_clonado', array('value'=>$id));?>
				<?php echo $this->Form->hidden('clonar', array('value'=>2));?>
