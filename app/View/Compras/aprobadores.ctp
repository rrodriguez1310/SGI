...
<table id="datatable" class="table table-striped table-bordered">
	...
	<?php foreach($comprasTotales as $key=>$comprasTotale) : ?>
		...
		?>
			<tr class="<?php echo $class; ?> <?php echo $comprasTotale['claseFac']; ?>">
				<td>
					<?php echo (!empty($comprasTotale['numFac']) ? $comprasTotale['numFac'] : $comprasTotale["IdRequerimiento"])?>
				</td>
				...
				<td>
					<span class="<?php echo $comprasTotale["Clase"]?>" data-toggle="tooltip" data-placement="top" title="Pendiente por aprobar en gerencia"><?php echo $comprasTotale["Rechazo"]?></span>
					<?php
						/*
