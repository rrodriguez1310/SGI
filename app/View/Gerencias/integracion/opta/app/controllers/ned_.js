...
var extras = {
	url: 'http://api.stg.cdf.fs.cl.nedp.io/', // http://api.cdf-qa.firesport.nedmedia.io/ - https://api.cdf.firesport.io/  - http://apifs.estadiocdf-s.nedmedia.io 
	header: {
	...
	return new Promise(function (resolve, reject) {
		...
		request.put({
			...
			if (err) {
				...
				reject('Ingresado campeonato ned exitoso');
			} else {
				resolve(body);
			}
		});
