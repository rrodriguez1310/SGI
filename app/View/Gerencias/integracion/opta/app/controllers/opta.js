...
var extras = {
    ...
    campeonatosPushNed: function(campeonatoOptaId, temporadaId) {        
        ...
        switch (campeonatoOptaId) {
            ...
            case 637:
            { //Super copa
                if (temporadaId == 2016 || temporadaId == 2017) {
                    respuesta = true;
                }
            }
                break;
    ...
    campeonatosPushAltavoz: function(campeonatoOptaId, temporadaId){
        ...
        switch (campeonatoOptaId) {
            case 370:
                { //Primera A Apertura
                    if (temporadaId == 2017 || temporadaId == 2018) {
                        respuesta = true;
                    }
                }
                break;
...
exports.optaFixtureF1 = function(req, res) {
    ...
    if (typeof req.headers['x-meta-competition-id'] !== 'undefined' && typeof req.headers['x-meta-season-id'] !== 'undefined') {
            ...
            for (var index = 0; index < partidosL; index++) {
                if (partidos[index].uID!='959925' && partidos[index].uID!='959926') { // parche 872 
                    ...
                    if (partidos[index].MatchType == 'Regular' && typeof partidos[index].GroupName === 'undefined') {
                        console.log("MatchDate Regular 1 1")
                        tipoFixture = 1;
                        ...
                        console.log("MatchDate Regular 1 Grupo")
                        tipoFixture = 1;
                        ...
                        console.log("MatchDate Key 1")
                        tipoFixture = 2;
                        var fechaAux = (parseInt(atributosCampeonato.competition_id) == 722 ? 30 : (parseInt(atributosCampeonato.competition_id) == 639 || parseInt(atributosCampeonato.competition_id) == 872 || parseInt(atributosCampeonato.competition_id) == 699 || parseInt(atributosCampeonato.competition_id) == 637) ? 0 : 15);                                
                        if (typeof fechasDates[parseInt(dateNumberKeys) + fechaAux] === 'undefined') {
                            
                            if (typeof partidos[index].FirstLegId !== 'undefined') {
                                console.log("MatchDate Key 1 Normal")
                                ...
                                console.log("MatchDate Key 1 Final")
                                // parche                                                
                                if ( (partidos[index].RoundType == 'Final' && partidos[index].uID != '964795') || (partidos[index].RoundType == "Play-Offs" && typeof partidos[index].Leg === 'undefined')) {
                                    ...
                                    var level = typeof partidos[index].RoundNumber !== 'undefined' ? String(partidos[index].RoundNumber) : (parseInt(atributosCampeonato.competition_id) == 637)? "1" : "2";
                                    var levelName = finales.indexOf(partidos[index].uID) >= 0 ? "Final" : typeof partidos[index].RoundType !== 'undefined' ? extras.roundTypeTraduccion(partidos[index].RoundType) : extras.matchTypeTraduccion(partidos[index].MatchType);
                                    levelName = parseInt(atributosCampeonato.competition_id) == 699 ? 'Final' : levelName;
                                    fechasDates[parseInt(dateNumberKeys) + fechaAux] = [partidos[index].date.getTime()];
                            ...
                            console.log("MatchDate Key otro")
                            if (typeof partidos[index].FirstLegId !== 'undefined') {
        ...
        // console.log((dataMatchDateYMatch.matchs));
        // return false;
        ...
        var championshipPushNed = function() {
            ...
            return new Promise(function(resolve, reject) {
                ...
                /*console.log({
                    "fullname": extras.competitionNameTraduccion(atributosCampeonato.competition_name) + ' ' + ((atributosCampeonato.competition_id + '-' + atributosCampeonato.season_id == '637-2017') ? '2018' : atributosCampeonato.season_id),
                    ...
                    "categoryFullName": extras.competitionNameTraduccion(atributosCampeonato.competition_name) + ' ' + ((atributosCampeonato.competition_id + '-' + atributosCampeonato.season_id == '637-2017') ? '2018' : atributosCampeonato.season_id),
                ...
                ned.championshipPush(atributosCampeonato.competition_id + '-' + atributosCampeonato.season_id, {
                    ...
                    .catch(function(err) {
                        console.log("err en championshipPushNed "+ JSON.stringify(err,null,2));
                        reject(err);
                });
            });
        }

        var validaPushNed = function() {
        ...
        validaPushNed().then(function(respuesta) {
        ...
        if (extras.campeonatosPushNed(competitionIdNed, seasonIdNed)) {
            ...
            switch (feedId) {
                ...
                case 'f40': //JUGADORES
                    ...
                    /*console.log(JSON.stringify(campeonatosEquipos,null,2));
                    return false;*/
                ...
                case 'f13': //INCIDENCIAS COMENTARIOS EN VIVO
                    ...
                    break;
                case 'f3':// TABLA POSICIONES (LEAGUE) EQUIPOS Y PUNTAJES
                    if (typeof req.body.soccerfeed.soccerdocument[0].competition[0].teamstandings !== 'undefined') {
                        ...
                        //console.log(JSON.stringify(positionYStatDataArray,null,2));
                        //return false;
