...
<div ng-controller="TransmisionControllerAddForm" ng-init="idTransmision = <?php echo $id; ?>">
	...
	<div class="row" ng-hide="loader">
		<div class="col-sm-12">
						...
						<div class="col-sm-6">
							<div class="table-responsive">
								<table class="table table-bordered table-hover">
									...
									<tr>
										<th>Estadio:</th>
										<td>{{produccion.estadio}}, {{produccion.estadio_ciudad}}, {{produccion.estadio_region}} {{produccion.estadio_region===RM ? "RM" : " REGIÓN"}}</td>
									</tr>
									<tr>
										<th>Campeonato:</th>
			...
			<div class="panel panel-default">
			    ...
			    <div class="panel-body">
	  				<div class='form-row'>
						<form class="form-horizontal" name="transporteAddForm" novalidate>
							<input type="hidden" ng-model="formulario.produccion_partidos_evento_id">
							...
							<div class='col-xs-10 offset-2 required'>
								<div class="form-group">
								...
								<!--div class="form-group">
									...
									<div class="col-md-5">
										<input type="text" disabled="disabled" class="form-control" name="puesta_marcha" name="puesta_marcha" ng-model="formulario[posicion].puesta_marcha" placeholder="Ingresa Puesta en Marcha">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label">Contacto Estadio</label>
									<div class="col-md-5">
										<input type="text" disabled="disabled" class="form-control" name="contacto" name="contacto" ng-model="formulario[posicion].contacto" placeholder="Ingresa Contacto Estadio">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label">Recepción de señal en CDF</label>
									<div class="col-md-5">
										<input type="text" disabled="disabled" class="form-control" name="recepcion" name="recepcion" ng-model="formulario[posicion].recepcion" placeholder="Ingresa Recepción Señal en CDF">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label">Anexo</label>
									<div class="col-md-5">
										<input type="text" disabled="disabled" class="form-control" name="anexo" name="anexo" ng-model="formulario[posicion].anexo" placeholder="Ingresa Anexo">
									</div>
								</div-->
							</div>

							<div class="form-group col-md-10 offset-2 text-center">
								<div class="col-md-12">
									<button type="button" ng-disabled="!deshabilitado" ng-click="addTransmision()" class="btn btn-lg btn-primary">Guardar <i class="fa fa-pencil"></i></button>
