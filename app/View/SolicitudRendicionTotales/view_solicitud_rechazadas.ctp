<div ng-controller="controllerRequerimientosRendicionRechazo">
...
<?php 
	echo $this->Html->script(array(
		...
		'angularjs/controladores/solicitudes_requerimientos_fondos/solicitudes_requerimientos_rendicion_rechazo_fijo',
