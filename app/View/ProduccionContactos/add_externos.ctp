<div class="col-md-10 col-md-offset-1">
	<?php echo $this->Form->create('ProduccionContacto', array('class' => 'form-horizontal')); ?>
			<h4><?php echo __('Registrar responsables externos producción'); ?></h4>
			<br/>
		...
		<div class="col-md-offset-2">
        	...
        	<!--a href="<?php echo $this->Html->url(array("action"=>"lsitar"))?>" class="volver btn btn-default btn-lg"><i class="fa fa-mail-reply-all"></i> Volver</a-->  
		</div>
...
<script>
	...
	$('#ProduccionContactoAddExternosForm').validate({	 
	...
	$('#ProduccionContactoAddExternosForm').submit(function () {
		if($(this).valid()){
