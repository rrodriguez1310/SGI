<div class="col-md-10 col-md-offset-1">
	<?php echo $this->Form->create('ProduccionContacto', array('class' => 'form-horizontal')); ?>
			<h4><?php echo __('Registrar responsables CDF producción'); ?></h4>
			<br/>
...
<script>
	...
	$('#ProduccionContactoAddResponsablesCdfForm').validate({	 
	...
	$('#ProduccionContactoAddResponsablesCdfForm').submit(function () {
		if($(this).valid()){
