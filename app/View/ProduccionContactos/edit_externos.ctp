<div class="col-md-10 col-md-offset-1">
	<?php echo $this->Form->create('ProduccionContacto', array('class' => 'form-horizontal')); ?>
			<h4><?php echo __('Editar Colaborador Externo Producción'); ?></h4>
			<br/>
			...
			<div class="form-group">
				...
				<div class="col-md-8"> 
					<?php echo $this->Form->input('nombre', array("class"=>"form-control required mayuscula", "placeholder"=>"Nombre Externo", "label"=>false, 'maxlength'=>'100', "id"=>"Nombre"));?>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<?php echo $this->Form->input('email', array("class"=>"form-control minuscula", "placeholder"=>"Email Externo", 'type'=>'text', 'maxlength'=>'100', "label"=>false));?>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<?php echo $this->Form->input('telefono', array("class"=>"form-control", "placeholder"=>"Teléfono Externo", "label"=>false, 'maxlength'=>'100'));?>
				</div>
			</div>
		...
		<div class="col-md-offset-2">
        	...
        	<a href="<?php echo $this->Html->url(array("action"=>"listar_externos"))?>" class="volver btn btn-default btn-lg"><i class="fa fa-mail-reply-all"></i> Volver</a>  
		</div>
...
<script>		
	...
	$('#ProduccionContactoEditExternosForm').validate({	 
