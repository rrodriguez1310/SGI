...
<form class="form-horizontal" method="post" id="fileinfo" name="fileinfo" role="form">
	<?php 
		...
		$attributes = array('div' => 'input', 'type' => 'radio', 'options' => $options, 'class'=>'radio_botom', "default"=>$comprasProductosTotale['TiposDocumento']['id'], 'required'=>true);
	...
	<fieldset>
		...
		<div class="form-group">
			...
			<div class="col-md-6">
				<?php echo $this->Form->input('numero_documento', array("required"=>true, "class"=>"col-xs-4 form-control", "label"=>false, 'placeholder'=>'N° Documento', 'default'=>$numeroDocumento, 'required'=>true));?>
			</div>
		</div>
    		...
    		*/
			...
			{	
				...
				else
				{
					...
					$("#neto_descuento").val(sumaSubTotalFormateado);
