<form class="form-horizontal" method="post" id="fileinfo" name="fileinfo" role="form">
	...
	<fieldset>
		...
		<div class="form-group">
			...
			<div class="col-md-6">
				<?php echo $this->Form->input('numero_documento', array("class"=>"col-xs-4 form-control", "label"=>false, 'placeholder'=>'N° Boleta', 'default'=>$comprasProductosTotale["ComprasFactura"][0]["numero_documento"]));?>
			</div>
		</div>
	...
	<div class="form-group">
		<div class="col-md-6 col-md-offset-4">
			<div class="alert alert-info">
				...
				<h4> Iva : $ <span class="iva"> <?php echo number_format($comprasProductosTotale['ComprasProductosTotale']['total'] - str_replace(".","",$comprasProductosTotale["ComprasProductosTotale"]["neto_descuento"]), 0, '', '.'); ?></span></h4>
	...
	<div class="form-group">
		<div class="col-md-6 col-md-offset-4">
			<button type="submit" class="btn-block btn btn-primary btn-lg generarOrden"><i class="fa fa-file-text-o"></i> Clonar doumento tributario</button>
		</div>
	</div>
</form>
<!-- Modal -->
