										...
										<table class="table table-condensed">
											...
											<tbody ng-repeat="objetivo in objetivos">
												<tr>
													...
													<td class="col-md-2">
														<input type="number" class="form-control sube" name="Ponderacion-{{$index}}" placeholder="Ponderación" ng-model="formulario.EvaluacionesObjetivo[$index].porcentaje_ponderacion" ng-disabled="formulario.EvaluacionesTrabajadore.evaluaciones_estado_id>=8"
														required>
													</td>
												</tr>
											</tbody>
