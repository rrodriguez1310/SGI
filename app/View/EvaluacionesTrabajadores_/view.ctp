							...
							<div> 	
								...
								<!-- Objetivos-->								
										<table class="table " style="margin-bottom: 0 !important">
											<thead>
												<tr class="success"> 
													<th colspan="2" class="col-md-8 success"> Descripción</th> 
													<th class="col-md-2 success text-center"> Indicador </th>
													<th class="col-md-2 success text-center"> fecha </th>
											...
											<tbody ng-repeat="objetivo in objetivos">										
												<tr ng-class="(formulario.EvaluacionesObjetivo[$index].observado_validador==1 && formulario.EvaluacionesTrabajadore.evaluaciones_estado_id==5 && !formulario.EvaluacionesObjetivo[$index].validado)? 'danger' : '' ">
													...
													<td class="text-right">
														{{(formulario.EvaluacionesObjetivo[$index].evaluaciones_unidad_objetivo_id==1)?objetivo.simbolo_indicador:''}} {{formulario.EvaluacionesObjetivo[$index].indicador | number:1}} {{(formulario.EvaluacionesObjetivo[$index].evaluaciones_unidad_objetivo_id>1)?objetivo.simbolo_indicador:''}}
													</td>
													<td class="text-center">
														{{formulario.EvaluacionesObjetivo[$index].fecha_limite_objetivo | date:'dd-MM-yyyy'}}
													</td>
