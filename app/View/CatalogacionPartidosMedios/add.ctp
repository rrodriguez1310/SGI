<div ng-controller="catalogacionPartidosMediosAdd" ng-cloak ng-init="idCatalogacionPartidos(<?php echo $this->request->pass[0]; ?>)">
	<p ng-bind-html="cargador" ng-show="loader"></p>
	<div ng-show="cargado">
		<div class="row">
			<div class="col-md-12 text-center">
				<h4>Registrar medio</h4>
			</div>
		</div>
		<br />
		<div class="row">
			<div class="col-md-6 col-md-offset-3">
				<form class="form-horizontal" name="formCatalogacionMediosAdd" novalidate>
					...
					<div class="form-group"  ng-class="{ 'has-error': !formCatalogacionMediosAdd.fechaIngreso.$valid }">
					...
					<div class="form-group" ng-class="{ 'has-error': !formCatalogacionMediosAdd.formato.$valid }">
					...
					<div class="form-group" ng-class="{ 'has-error': !formCatalogacionMediosAdd.bloque.$valid }">
					...
					<div class="form-group" ng-class="{ 'has-error': !formCatalogacionMediosAdd.soporte.$valid }">
						<label class="control-label col-md-3" for="bloque">
							Soporte
						</label>
						<div class="col-md-9">
					...
					<div class="form-group" ng-class="{ 'has-error': !formCatalogacionMediosAdd.almacenamiento.$valid }">
						<label class="control-label col-md-3" for="bloque">
							Almacenamiento
						</label>
						<div class="col-md-9">
					...
					<div class="form-group" ng-class="{ 'has-error': !formCatalogacionMediosAdd.copia.$valid }">
					...
					<div class="form-group" ng-class="{ 'has-error': !formCatalogacionMediosAdd.observacion.$valid }">
					...
					<div class="form-group">
						<div class="col-md-12 text-center">
							<button class="btn btn-primary btn-lg" ng-disabled="!formCatalogacionMediosAdd.$valid || registrando" ng-click="registrarCatalogacionPartidosMedios()"><i class="fa fa-pencil"></i> Registrar</button>
							<?php echo $this->Html->link('<i class="fa fa-mail-reply-all"></i> Volver</a>', array("controller"=>"catalogacion_partidos", "action"=>"view", $this->request->pass[0]), array("class"=>"btn btn-default btn-lg baja", "escape"=>false)); ?>
						</div>
					</div>
				</form>	
			</div>
