<div ng-controller="controllerMontosFijosLista" >
...
<?php 
	echo $this->Html->script(array(
		...
		'angularjs/servicios/montos_fijos/servicioMontosFijos',
		'angularjs/controladores/montos_fondo_fijos/montosFijosLista',
