<div ng-controller="catalogacionPartidosAdd" ng-cloak>
		...
		<div class="row">
			<div class="col-md-6 col-md-offset-3">
				<form class="form-horizontal" name="ingestasAddForm" novalidate>
					...
					<div class="form-group">
						<div class="col-md-12 text-center">
							<button class="btn btn-primary btn-lg" ng-disabled="!ingestasAddForm.$valid || registrando" ng-click="registrarCatalogacionPartido()"><i class="fa fa-pencil"></i> Registrar</button>
