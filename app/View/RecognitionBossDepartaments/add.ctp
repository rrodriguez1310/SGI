...
<div class="col-md-12 col-md-offset-1">
	...
	<?php echo $this->Form->create('RecognitionBossDepartament', array('class' => 'form-horizontal')); ?>
        ...
        <div class="form-group">
            <label for="" class="col-sm-3 control-label">Jefe: <span class="aterisco">*</span></label>
            <div class="col-sm-5">
                <?php echo $this->Form->input('', array("value" => $salida['Trabajadore']['nombre'], "disabled","type"=>"text", "class"=>"form-control", "label"=>false));?>
            </div>
        </div>

		<fieldset>
			<?php echo $this->Form->input('id', array("value" => $newId,'type' => 'hidden'));?>
            <?php echo $this->Form->input('employed_id', array("value" => $salida['Trabajadore']['id'],'type' => 'hidden'));?>
