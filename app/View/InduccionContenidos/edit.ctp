...
<div class="col-sm-offset-3 col-sm-8">
	<h2><?php echo __('Actualizar Contenido'); ?></h2>
</div>
	...
	<?php echo $this->Form->create('InduccionContenido',array('type' => 'file', 'class' => 'form-horizontal')); ?>
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<?php echo $this->Form->input('descripcion', array("type"=>"textArea", "class"=>"form-control", "label"=>false,"id"=>"froala-editor", "name"=>"descripcion", "value"=>$contenido));?>
				</div>
			</div>
