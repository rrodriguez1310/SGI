...
-->
				...
				<a href="<?php echo $this->Html->url(array("controller" => "recognitionCollaborators" ,"action"=>"products"))?>" class="volver btn btn-default"><i class="fa fa-mail-reply-all"></i> Volver</a>
				</div> 
			</div>
		</div>
	</div>
