<div class="col-sm-offset-3 col-sm-8">
	<h2><?php echo __('Registrar Producto'); ?></h2>
</div>
<div class="col-md-12 col-md-offset-1">
	<br/>
	<div class="recognitionProducts form">
	<?php echo $this->Form->create('RecognitionProduct',array('type' => 'file', 'class' => 'form-horizontal')); ?>
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<?php echo $this->Form->input('category_id', array("type"=>"select", "class"=>"form-control", "label"=>false, 'empty' => 'Seleccione...'));?>
				</div>
			</div>
