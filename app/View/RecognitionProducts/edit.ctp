<div class="col-sm-offset-3 col-sm-8">
	<h2><?php echo 'Registrar Producto'; ?></h2>
</div>
<div class="col-md-12 col-md-offset-1">
	<br/>
	<div class="recognitionProducts form">
	<?php echo $this->Form->create('RecognitionProduct',array('type' => 'file',  'novalidate' => 'novalidate', 'class' => 'form-horizontal')); ?>
	...
	<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<?php echo $this->Form->input('image', array('type' => 'file', "accept"=>".jpg, .jpeg, .png", "class"=>"form-control", "label"=>false, 'id' => 'foto',));?>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<?php echo $this->Form->input('points', array("type"=>"number", "min"=>"0", "class"=>"form-control", "label"=>false));?>
				</div>
			</div>

			<div class="form-group">
				<label for="" class="col-sm-3 control-label">Cantidad: <span class="aterisco">*</span></label>
				<div class="col-sm-5">
					<?php echo $this->Form->input('quantity', array("type"=>"number", "min"=>"0", "class"=>"form-control", "label"=>false));?>
				</div>
			</div>

			<div class="form-group">
				<label for="inputPassword3" class="col-sm-3 control-label">Categoría: <span class="aterisco">*</span></label>
				<div class="col-sm-5">
					<?php echo $this->Form->input('category_id', array("type"=>"select", "class"=>"form-control", "label"=>false));?>
				</div>
			</div>
