...
<div class="col-md-6 col-md-offset-3">
	<?php echo $this->Form->create('Menu'); ?>
		<fieldset>
			<h4><?php echo __('Edición de menús'); ?></h4>
			<?php echo $this->Form->input('id');?>
			<div class="required-field-block"  class="col-xs-4" >
				<?php echo $this->Form->input('nombre', array("class"=>"form-control mayuscula", "placeholder"=>"Ingrese nuevo nombre", "label"=>false, "required"=>"required"));?>
			</div>			
		</fieldset>
		<br/><br/><br/>
