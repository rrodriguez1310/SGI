app.controller('controllerMontosFijosLista', ['Flash', '$scope', '$http', '$filter', 'servicioMontosFijos', function(Flash, $scope, $http, $filter, servicioMontosFijos) {
  ...
  //  $scope.btnmontos_fondo_fijosedit=true;
    ...
    servicioMontosFijos.listaMontosFondoFijosLista().success(function(data){
