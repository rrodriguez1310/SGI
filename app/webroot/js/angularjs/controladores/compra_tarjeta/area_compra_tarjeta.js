app.controller('controllerAreaCompras', ['$scope', '$http', '$filter', 'areaCompraTarjeta', function($scope, $http, $filter, areaCompraTarjeta) {
   ...
   $scope.btncompras_tarjetasdelete=true;
    ...
    areaCompraTarjeta.viewAreajson(id).success(function(data){
//console.log(123,id);
