app.controller('controllerRequerimientosArea', ['$scope', '$http', '$filter', 'solicitudesRequerimiento', function($scope, $http, $filter, solicitudesRequerimiento) {
   ...
   // $scope.guardarRendicion = [];
    ...
    solicitudesRequerimiento.listaRequerimientosArea().success(function(data){
