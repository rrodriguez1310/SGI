app.controller('controllerRequerimientosRendicionRechazo', ['$scope', '$http', '$filter', 'solicitudesRequerimiento', function($scope, $http, $filter, solicitudesRequerimiento) {
   ...
   // $scope.guardarRendicion = [];
    ...
    solicitudesRequerimiento.listaSolicitudRendiconFondoRendir().success(function(data){
