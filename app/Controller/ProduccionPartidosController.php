...
class ProduccionPartidosController extends AppController {
	...
	public function add($idProduccionPartidos = null) {
		...
		$productoresTrab = $this->trabajadoresCargos(array(102,143,139,201));
		...
		$ternoVestuarios = $this->ProduccionPartidosVestuario->find("list", array("fields"=>array("id","nombre"),"conditions"=>array("tipo_vestuario"=>"terno", "estado"=>1)));
		//$camisaVestuarios = $this->ProduccionPartidosVestuario->find("list", array("fields"=>array("id","nombre"),"conditions"=>array("tipo_vestuario"=>"camisa", "estado"=>1)));
		$panueloVestuarios = $this->ProduccionPartidosVestuario->find("list", array("fields"=>array("id","nombre"),"conditions"=>array("tipo_vestuario"=>"panuelo", "estado"=>1)));
		$corbataVestuarios = $this->ProduccionPartidosVestuario->find("list", array("fields"=>array("id","nombre"),"conditions"=>array("tipo_vestuario"=>"corbata", "estado"=>1)));	
		//vestuario
		$this->set(compact("ternoVestuarios","panueloVestuarios","corbataVestuarios"));
	...
	public function edit($id = null) {
		...
		$operadorTrackVisionEmp = $this->trabajadoresEmpresaTipo('operador-cdf');
		foreach ($operadorTrackVisionEmp as $key => $operadorTrackVisionE) { $operadorTrackVision["E:".$key] = $operadorTrackVisionE; }
		...
		//solo empresas
		$this->set("operadorTrackVision", $operadorTrackVision);
		$this->set("locutor", $locutor);
		$this->set("musicalizador", $musicalizador);
